...
builder.Services.AddScoped<ToDto>();
builder.Services.AddScoped<PostsBusinessLayer>();
builder.Services.AddScoped<CategoriesBusinessLayer>();
builder.Services.AddScoped<SubscribersBusinessLayer>();
builder.Services.AddScoped<CommentsBusinessLayer>();
...
builder.Services.AddCors(options => options.AddPolicy(name: "NgOrigins", policy =>
{
    ...
    policy.WithOrigins("http://localhost:4300").AllowAnyMethod().AllowAnyHeader();
}));
